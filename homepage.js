...
(function() {
  ...
  function init() {
    ...
    let arithmeticButton = id("do-arithmetic-button");
    arithmeticButton.addEventListener("click", computeExpression);
  ...
  function computeExpression() {
    ...
    let result = evaluatePostFixExpression(postFixExpression);

    let paragraph = document.createElement('p');
    paragraph.textContent = infixExpression + " = " + result;
    let calculatorSection = id("arithmetic-calculator-section");
    calculatorSection.appendChild(paragraph);
